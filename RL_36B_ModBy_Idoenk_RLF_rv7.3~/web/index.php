...
/*
   ...
   |  Last Modified  | by Ali.Dbg at 2010                                         |
   |  Site           | http://phpr0xi.blogspot.com	                              |
   |  Email          | Ali.Dbg@Gmx.com                                            |
   +-----------------+------------------------------------------------------------+
*/
...
if (isset($_GET[$_config['url_var_name']]) && isset ($_POST['P0ST2GET']))
{
	$GET = '';
...
else
{
    ...
    if (!isset($_GET['nf']))
    {
        ...
        $_url_form      = '<script type="text/javascript" src="pjs.js"></script>' . "\n"
						 .'<script language="JavaScript">'
						 ."miniform('" .rawurldecode( $_url) . (!empty ($POST) ? urldecode('?isP0ST=1&' . $POST) : '') . "');"
						 .'</script>';
